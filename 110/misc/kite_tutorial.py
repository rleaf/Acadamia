...
""" PART 1: CODE COMPLETIONS ===================================================
    ...
    Look for Kite's icon on the right-hand side to see which completions are
    coming from Kite.
"""
...
# • Put your cursor at the end of the line marked with "<--".
# • Type "m", and Kite will suggest calling "dumps(<obj>, sort_keys=<bool>)".
# • Use Kite's completions and the tab key to fill out the function call. The
#   correct function call should be "json.dumps(obj, sort_keys=sort_keys)".
# • Remember to press ctrl+space if autocompletions aren't on.
